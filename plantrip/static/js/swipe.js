...
//window.addEventListener("load", function(event) {
	...
	function stackedCards () {
		...
		function changeBackground() { 
			...
			document.body.style.backgroundColor = '#FFE65B';
		};
		...
		function onSwipeLeft() {
			...
			if(useOverlays){
				...
				resetOverlayLeft();
				dislike.push(currentElementObj.children[0].innerText)
				console.log(dislike)
			}
		...
		function onSwipeRight() {
			...
			if(useOverlays){
				...
				transformUi(1000, 0, 0, topObj); //Move topOverlay
				resetOverlayRight();
				console.log(currentElementObj.children[0].innerText)
				like.push(currentElementObj.children[0].innerText)
				console.log(like)
			}
		...
		function onSwipeTop() {
			...
			if(useOverlays){
				...
				resetOverlays();
				soso.push(currentElementObj.children[0].innerText)
				console.log(soso)
			}
